...
import putra.kobal.ChatKeDriver;
 ...
 */
public class RecycleAdapteraChatDriver extends RecyclerView.Adapter<RecycleViewHolderChat> {
    ...
    public RecycleAdapteraChatDriver(final Context context) {
        ...
        Gref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if (from_id.equals(BerandaDriver.id) && to_id.equals(ChatKeUser.to_id)
                            || to_id.equals(BerandaDriver.id) && from_id.equals(ChatKeUser.to_id)){
    ...
    public void onBindViewHolder(RecycleViewHolderChat holder, int position) {
        ...
        if (BerandaDriver.id.equals(list_fromID.get(position).toString())){
